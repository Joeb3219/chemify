...
public class UnitConverter extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(unitType == null) unitType = (Spinner) findViewById(R.id.unit_type);
		if(fromUnit == null) fromUnit = (Spinner) findViewById(R.id.unit_from);
		if(toUnit == null) toUnit = (Spinner) findViewById(R.id.unit_to);
	...
	public void onStart(){
		...
		unitType.setOnItemSelectedListener(new OnItemSelectedListener() {
			public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
		    	...
		    	fromUnit.setAdapter(new ArrayAdapter<String>(parentView.getContext(), android.R.layout.simple_spinner_dropdown_item, mainUnits));
		    	toUnit.setAdapter(new ArrayAdapter<String>(parentView.getContext(), android.R.layout.simple_spinner_dropdown_item, mainUnits));
	...
	private void calculate(){
		...
		double val = 1.00;
		if(!valueFrom.equals("") && !valueFrom.equals(" ")) val = Double.parseDouble(valueFrom);
