...
public class Constant {
	...
	public static Constant AVOGADROS_NUMBER = new Constant("Avogadro's Number", "N", 6.022 * Math.pow(10, 23), "");
	...
	public static Constant ELECTRON_CHARGE = new Constant("Electron Charge", "e", 1.6 * Math.pow(10, -19), "Coulombs");
	...
	public boolean matchesSearch(String str){
		...
		if(symbol.equalsIgnoreCase(str) || name.equalsIgnoreCase(str) || symbol.replace("<sub>", "").replace("</sub>", "").equalsIgnoreCase(str)) return true;
		return false;
	}
